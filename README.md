...
- Tailwind totalmente customizado via CDN
- Ícone animado com keyframes personalizados
- Paleta exclusiva em tons de roxo
- Formulário simples e estilizado de inscrição
- Efeitos de hover e animações sutis
...
git clone https://github.com/elisdevweb/TechIA-Newsletter.git

2️⃣ Acesse a pasta <br>
cd TechIA-Newsletter
